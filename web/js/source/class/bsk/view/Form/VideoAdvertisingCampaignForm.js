...
qx.Class.define("bsk.view.Form.VideoAdvertisingCampaignForm",
{
    ...
    construct : function(controller, Row) {
        ...
        this.__list.push(new bsk.view.Form.VideoAdvertisingCampaign.Common(this.uReq));
        this.__list.push(new bsk.view.Form.VideoAdvertisingCampaign.Upload(this.uReq));
        this.__list.push(new bsk.view.Form.VideoAdvertisingCampaign.UsersTargeting(this.uReq));
        this.__list.push(new bsk.view.Form.VideoAdvertisingCampaign.RegionTargeting(this.uReq));
        this.__list.push(new bsk.view.Form.VideoAdvertisingCampaign.CategoryTargeting(this.uReq));
