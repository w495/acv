...
qx.Class.define("bsk.view.Form.GenericForm",
{
    ...
    members : {
        ...
        buildForm : function(formDescription) {
            ...
            for(var i=0; i<formDescription.fields.length; i++) {
                ...
                if(E.validation != undefined) {
                    ...
                    switch(E.validation.type) {
                        case "int":
                            FValidation = bsk.view.Form.AbstractForm.num();
                            break;
                        case "range":
                        ...
                        case "string-range":
                            ...
                            break;
                        case "string-max":
                            FValidation = bsk.view.Form.AbstractForm.checkStringMax(E.validation.max, FField);
                            break;
                        case "equal":
                            FValidation = bsk.view.Form.AbstractForm.password(E.validation.field, this.form, FField);
                            break;
                    }
                }
            ...
            if(formDescription.render == "single")
                ...
                this.controller.placeForm(new bsk.view.HorisontalRenderer(this.form));
        ...
        _onLoadFormDataCompl : function(response) {
            var result = response.getContent();
            if (bsk.util.errors.process(this, result)==false) return;
                ...
                if(fFields[key] != undefined) {
                    ...
                    if(fField instanceof qx.ui.form.SelectBox) {
                        ...
                        if(selField != undefined) {
                            ...
                            var E = fField.bsk_special.input.extra_value
