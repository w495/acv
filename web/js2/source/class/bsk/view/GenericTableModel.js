...
qx.Class.define("bsk.view.GenericTableModel",
{
        ...
        updateDataCellRenderers : function() {
            ...
            for(var i=0; i<this.tabDescription.columns.length; i++) {
                ...
                switch(I.type) {
                    ...
                    case "sec":
                        var own = this;
                        this.setSortMethods(i, {"ascending": function(row1, row2){ return own.mySort(row1, row2, arguments.callee.columnIndex, 1)}, "descending": function(row1, row2){ return own.mySort(row1, row2, arguments.callee.columnIndex, -1)} });
                        break;
                }
